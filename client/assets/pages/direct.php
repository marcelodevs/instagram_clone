...
<head>
  ...
  <?php if ($preferences_dark_mode) { ?>
    ...
    <link rel="stylesheet" href="../css/dark_mode/direct.css">
  <?php } else { ?>
    <link rel="stylesheet" href="../css/cabecalho.css">
    <link rel="stylesheet" href="../css/direct.css">
  <?php } ?>
  <link rel="icon" href="../img/VsNE-OHk_8a.png">
  <title>Caixa de Entrada • Bate-papos</title>
</head>
      ...
      <div class="chats">
        <?php for ($i = 0; $i < count($all_users); $i++) : ?>
          <?php if ($all_users[$i]['username'] <> $user['username']) : ?>
            <div class="corpo-do-perfil" onclick="window.location.href = './chat/direct-user.php?name=<?php echo $all_users[$i]['username'] ?>'">
              <div class="row">
