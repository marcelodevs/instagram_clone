...
<head>
  ...
  <?php if ($preferences_dark_mode) { ?>
    <link rel="stylesheet" href="../css/dark_mode/style.css">
      ...
      <div class="coluna-esquerda">
        ...
        <div class="postagens">
          <div class="informacoes">
            ...
            <img src="../img/op.png" alt="" class="opcoes">
          </div>
          <img src="../img/feed-image-1.png" alt="" class="capa-post">
          <div class="conteudo-da-postagem">
            <div class="reacoes-icons">
              <img src="../img/curtir.png" alt="" class="icon">
              <img src="../img/comentario.png" alt="" class="icon">
              <img src="../img/enviar.png" alt="" class="icon">
              <img src="../img/salvar.png" alt="" class="icon salvar">
            </div>
            <p class="curtidas">20 curtidas</p>
            <p class="descricao">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam non veritatis minima
              autem architecto dolorum consectetur. Excepturi natus illum maiores error doloribus molestiae. Iure
              repellat sint, illum ea harum aliquam?</p>
            <p class="tempo-post">7 minutos atrás</p>
          </div>
          <div class="comentario-postagem">
            <img src="../img/sorriso.png" alt="" class="icon">
            <form action="./server/js/comment-publi.js" method="post" class="comentario-form">
              <input type="text" name="msg" class="comentario-msg" placeholder="Comentar na postagem">
              <button class="comentario-btn" type="submit">Postar</button>
            </form>
          </div>
        </div>
      </div>
