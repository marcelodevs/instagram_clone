...
if (isset($_GET['name'])) {
  ...
  $userchat = $obj_user->search($username);
...
<head>
  ...
  <?php if ($preferences_dark_mode) { ?>
    <link rel="stylesheet" href="../../css/dark_mode/cabecalho.css">
    <link rel="stylesheet" href="../../css/dark_mode/direct-chat.css">
  <?php } else { ?>
    <link rel="stylesheet" href="../../css/cabecalho.css">
    <link rel="stylesheet" href="../../css/direct-chat.css">
  <?php } ?>
  <link rel="icon" href="../../img/VsNE-OHk_8a.png">
  <title>Instagram • Bate-papos</title>
</head>
...
<body>
  ...
  <nav class="menu-principal">
    <div class="menu-links">
      <svg aria-label="Instagram" class="x1lliihq x1n2onr6 x5n08af logo-marca" fill="currentColor" height="29" role="img" viewBox="32 4 113 32" width="103">
      ...
      <form action="#" method="post" autocomplete="off" class="busca-topo busca-topo-form">
        <input type="text" name="ms" class="busca-topo" id="searchInput" placeholder="Pesquisar...">
      </form>
      <!-- <div id="searchResults"></div> -->

      <div class="menu-icons">
        <svg aria-label="Página inicial" class="x1lliihq x1n2onr6 x5n08af icon" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24" onclick="window.location.href = '../index.php'">
        ...
        <svg aria-label="Messenger" class="x1lliihq x1n2onr6 x5n08af icon" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24" onclick="window.location.href = '../direct.php'">
        ...
        <svg aria-label="Nova publicação" class="x1lliihq x1n2onr6 x5n08af icon" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24" onclick="window.location.href = '../index.php'">
        ...
        <svg aria-label="Explorar" class="x1lliihq x1n2onr6 x5n08af icon" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24" onclick="window.location.href = '../index.php'">
        ...
        <svg aria-label="Notificações" class="x1lliihq x1n2onr6 x5n08af icon" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24" onclick="window.location.href = '../index.php'">
  ...
  <div class="main-chat">
    <div class="chats-users">
      <div class="row">
        <p class="name-user">
          <?php echo $user['username'] ?><svg aria-label="Ícone de seta para baixo" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="12" role="img" viewBox="0 0 24 24" width="12">
        ...
        <div class="modal" id="modal">
          <div class="modal-content">
            <form action="./login.php" method="post" autocomplete="off">
              <input type="text" name="login" class="input-login input" placeholder="Telefone, nome de usuário ou e-mail" required>
              <input type="password" name="password" class="input-senha input" placeholder="Senha" required>
              <button type="submit" class="btn-sub">Entrar</button>
              <br>
              <hr><br>
    ...
    <div class="messages">
      <div class="information-user">
        <img src="data:image/*;base64,<?php echo $userchat['profile_photo_url'] ?>" class="user-chat-img">
        <p class="fullname"><strong><?php echo $userchat['full_name'] ?></strong></p>
        <p class="user-name"><?php echo $userchat['username'] ?> · Instagram</p>
        <button onclick="window.location.href = '../perfil-user.php?name=<?php echo $userchat['username'] ?>'">Ver perfil</button>
      </div>
      <div class="msg-container">
        <div class="send-message">
          <img src="../../img/sorriso.png" alt="" class="icon">
          <form action="" method="post" class="comentario-form" autocomplete="off">
            <input type="text" name="msg" class="comentario-msg" placeholder="Enviar mensagem">
            <button class="comentario-btn" type="submit">Enviar</button>
          </form>
        </div>
      </div>
    </div>
  ...
  <script src="../../js/direct-chat.js"></script>
